            ...
            <form @submit.prevent="validateForm('form-1')" class="columns column is-multiline is-12" data-vv-scope="form-1">
                ...
                <div class="column is-12">
                    ...
                    <p class="control has-icon has-icon-right">
                        <input value="demo@example.com" v-model="login.email" name="email" v-validate="'required|email'" :class="{'input': true, 'is-danger': errors.has('form-1.email') }" type="text" placeholder="Email">
                ...
                <div class="column is-12">
                    ...
                    <p class="control has-icon has-icon-right">
                        <input value="12345" v-model="login.password" name="password" v-validate="'required|min:5'" :class="{'input': true, 'is-danger': errors.has('form-1.password') }" type="password" placeholder="Password">

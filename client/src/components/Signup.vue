        ...
        <form @submit.prevent="validateForm('form-1')" class="columns column is-multiline is-12" data-vv-scope="form-1">
            <div class="column is-12">
                ...
                <p class="control has-icon has-icon-right">
                    <input v-model="signup.name" name="name" v-validate="'required|min:5'" :class="{'input': true, 'is-danger': errors.has('form-1.name') }" type="text" placeholder="Name">
            ...
            <div class="column is-12">
                ...
                <p class="control has-icon has-icon-right">
                    <input v-model="signup.email" name="email" v-validate="'required|email'" :class="{'input': true, 'is-danger': errors.has('form-1.email') }" type="text" placeholder="Email">
            ...
            <div class="column is-12">
                ...
                <p class="control has-icon has-icon-right">
                    <input v-model="signup.password" name="password" v-validate="'required|min:5'" :class="{'input': true, 'is-danger': errors.has('form-1.password') }" type="password" placeholder="Password">
            ...
            <div class="column is-12">
                ...
                <p class="control has-icon has-icon-right">
                    <input v-model="signup.phone" name="phone" v-validate="'required|numeric'" :class="{'input': true, 'is-danger': errors.has('form-1.phone') }" type="text" placeholder="Phone">
            ...
            <div class="column is-12">
                ...
                <p class="control has-icon has-icon-right">
                    <textarea v-model="signup.bio" name="bio" v-validate="'max:255'" :class="{'textarea': true, 'is-danger': errors.has('form-1.bio') }" type="text" placeholder="Bio"></textarea>
